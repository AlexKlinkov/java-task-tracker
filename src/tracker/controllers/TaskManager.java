...
public interface TaskManager {
    ...
    void updateTask(Task task); // 2.5 Обновление задачи по идентификатору

    void updateSubTask(Subtask subtask); // 2.5 Обновление подзадачи по идентификатору

    void updateEpic(Epic epic); // 2.5 Обновление задачи (сложные) эпические по идентификатору
