...
public class Main {
        public static void main(String[] args) {
            ...
            Epic epic1 = new Epic("Пройти курс по Java", "Сдать вовремя все задачи", Status.NEW, null, null);
            ...
            System.out.println(taskManager.getHistoryManager().getHistory()); // Запрашиваем историю и проверяем порядок элементов
            ...
            System.out.println(taskManager.getHistoryManager().getHistory()); // проверяем, что порядок в истории сохранился,
            // после удаления подзадачи № 2 с ID-3

            // Эпик без подзадач
            Epic epic2 = new Epic("Пережить трудные времена", "Не падать духом", Status.NEW, null, null);
